...
namespace Server
{
    ...
    public class Mobile : IEntity, IHued, IComparable<Mobile>, ISerializable
    {
        ...
        public virtual void ProcessDelta()
        {
            ...
            // GeNova: KR Support (Added condition)
            if (m.m_Map != null && (sendRemove || sendIncoming || sendPublicStats || sendHits || sendMoving || sendOPLUpdate || sendHair || sendFacialHair || sendFace))
            {
                Mobile beholder;
