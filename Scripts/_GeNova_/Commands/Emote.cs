    ...
    public class EmoteGump : Gump
    {
            ...
            : base(600, 50)
        {
            ...
            switch (page)
            {
                case EmotePage.P1:
                    {
                        ...
                        AddButtonLabeled(10, 140, GetButtonID(1, 3), "Aplausos");
                        AddButtonLabeled(10, 165, GetButtonID(1, 4), "Coçar o naris");
                        AddButtonLabeled(10, 190, GetButtonID(1, 5), "Reverencia");
                        AddButtonLabeled(10, 215, GetButtonID(1, 6), "Tossir");
                        AddButtonLabeled(10, 240, GetButtonID(1, 7), "Arrotar");
                        AddButtonLabeled(10, 265, GetButtonID(1, 8), "Pigarrear");
                        AddButtonLabeled(10, 290, GetButtonID(1, 9), "Tossir forte");
                ...
                case EmotePage.P2:
                    {
                        AddButtonLabeled(10, 90, GetButtonID(1, 13), "Surpresa");
                        AddButtonLabeled(10, 115, GetButtonID(1, 14), "Risos");
                        ...
                        AddButtonLabeled(10, 265, GetButtonID(1, 20), "Beijo");
                        AddButtonLabeled(10, 290, GetButtonID(1, 21), "Gargalhada");
                ...
                case EmotePage.P3:
                    {
                        ...
                        AddButtonLabeled(10, 165, GetButtonID(1, 28), "Gritar");
                        AddButtonLabeled(10, 190, GetButtonID(1, 29), "Silencio");
                        ...
                        AddButtonLabeled(10, 340, GetButtonID(1, 35), "Cospir");
                        AddButtonLabeled(10, 365, GetButtonID(1, 36), "Mostra Lingua");
                ...
                case EmotePage.P4:
                    {
                        ...
                        AddButtonLabeled(10, 115, GetButtonID(1, 38), "Assoviar");
