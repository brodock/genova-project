...
namespace Server.Mobiles
{
	...
	public class BlueAncientDragon : BaseCreature
	{
		[Constructable]
		public BlueAncientDragon () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "Dragao Anciao Azul";
			Body = 46;
			BaseSoundID = 362;
			Hue = Utility.RandomList( 1164, 1282 );
		...
		public BlueAncientDragon( Serial serial ) : base( serial )
		{
		}
