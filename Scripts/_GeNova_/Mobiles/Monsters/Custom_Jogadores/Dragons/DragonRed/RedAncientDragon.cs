...
namespace Server.Mobiles
{
	...
	public class RedAncientDragon : BaseCreature
	{
		[Constructable]
		public RedAncientDragon () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "Dragao Anciao Vermelho";
			Body = 46;
			BaseSoundID = 362;
			Hue = Utility.RandomList( 38, 1157 );
		...
		public RedAncientDragon( Serial serial ) : base( serial )
		{
		}
