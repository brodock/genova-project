...
namespace Server.Mobiles
{
	...
	public class GreenAdultDragon : BaseCreature
	{
		[Constructable]
		public GreenAdultDragon () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "Dragao Verde Adulto";
		...
		public GreenAdultDragon( Serial serial ) : base( serial )
		{
		}
