...
namespace Server
{
	...
	{	
		public MondainsLegacyGump() : base( 50, 50 )
		{
			...
			AddButton( 20, 285, MondainsLegacy.Spellweaving ? 0x939 : 0x938, MondainsLegacy.Spellweaving ? 0x939 : 0x938, 10, GumpButtonType.Reply, 0 );
			AddButton( 20, 310, MondainsLegacy.PublicDonations ? 0x939 : 0x938, MondainsLegacy.PublicDonations ? 0x939 : 0x938, 11, GumpButtonType.Reply, 0 );
			...
			AddLabel( 45, 281, 0x226, "Spellweaving" );
			AddLabel( 45, 306, 0x226, "PublicDonations" );
