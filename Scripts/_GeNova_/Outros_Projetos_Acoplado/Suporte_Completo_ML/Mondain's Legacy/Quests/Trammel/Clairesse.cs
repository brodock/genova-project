...
namespace Server.Engines.Quests
{
	...
	{			
		public override TimeSpan RestartDelay{ get{ return TimeSpan.FromMinutes( 2 ); } }
		
		/* A Stitch in Time */
		public override object Title{ get{ return 1075523; } }
		...
		public override object Complete{ get{ return 1075528; } }
		
		public StitchInTimeQuest() : base()
		{								
	...
	public class Clairesse : MondainQuester
	{
		...
		[Constructable]
		public Clairesse() : base( "Clairesse", "the servant" )
		{		
		}
	...
	public class OldRing : GoldRing
	{
		...
		public OldRing( Serial serial ) : base( serial )
		{
		}
	...
	public class OldNecklace : Necklace
	{
		...
		[Constructable]
		public OldNecklace() : base()
		{
			Hue = 0x222;
		}
		
		public OldNecklace( Serial serial ) : base( serial )
		{
		}
