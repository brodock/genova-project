...
{	
	...
	{				
		/* Proof of the Deed */
		public override object Title{ get{ return 1072339; } }
	...
	public class Onallan : MondainQuester
	{
		...
		[Constructable]
		public Onallan() : base( "Elder Onallan", "the wise" )
		{			
		}
		
		public Onallan( Serial serial ) : base( serial )
		{
		}
