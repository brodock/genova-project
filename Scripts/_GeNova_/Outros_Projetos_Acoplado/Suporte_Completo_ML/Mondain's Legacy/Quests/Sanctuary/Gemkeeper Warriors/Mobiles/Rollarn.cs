...
{	
	...
	{				
		...
		/* Brotherly Love */
		public override object Title{ get{ return 1072369; } }
		...
		public override object Description{ get{ return 1072585; } }
		
		/* *looks disappointed* Let me know if you change your mind. */
		public override object Refuse{ get{ return 1072587; } }
		
		/* You haven't lost the letter have you?  It must be delivered to Ahie directly.  Give it into no other hands. */
		public override object Uncomplete{ get{ return 1072588; } }
		
		/* Yes, can I help you? */
		public override object Complete{ get{ return 1074579; } }
	
		public BrotherlyLoveQuest() : base()
		{			
	...
	{		
		...
		[Constructable]
		public Rollarn() : base( "Lorekeeper Rollarn", "the keeper of tradition" )
		{			
		}
		
		public Rollarn( Serial serial ) : base( serial )
		{
		}
	...
	public class PersonalLetterAhie : BaseQuestItem
	{
		...
		[Constructable]
		public PersonalLetterAhie() : base( 0x14ED )
		{
		}
		
		public PersonalLetterAhie( Serial serial ) : base( serial )
		{
		}
