...
{	
	...
	{	
		public override object ConfirmMessage{ get{ return 1073642; } } // Are you sure you want to follow the elven ways?
		public override object IncompleteMessage{ get{ return 1074002; } } // You have begun to walk the path of reclaiming your heritage, but you have not learned all the lessons before you.
		
		[Constructable]
		public Darius() : base( "Darius", "The Wise" )
		{   
		}
		
		public Darius( Serial serial ) : base( serial )
		{
		}  
