...
{							
	...
	{							
		...
		public SomethingToWailAboutQuest() : base()
		{			
	...
	{							
		...
		public ViciousPredatorQuest() : base()
		{			
	...
	public class Jelrice : MondainQuester
	{
		...
		[Constructable]
		public Jelrice() : base( "Jelrice", "the trader" )
		{			
		}
		
		public Jelrice( Serial serial ) : base( serial )
		{
		}
