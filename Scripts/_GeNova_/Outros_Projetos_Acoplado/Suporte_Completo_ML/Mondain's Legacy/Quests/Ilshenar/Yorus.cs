...
{					
	...
	{							
		/* Guile, Irk and Spite */
		public override object Title{ get{ return 1074739; } }
	...
	public class Yorus : MondainQuester
	{
		...
		[Constructable]
		public Yorus() : base( "Yorus", "the tinker" )
		{			
		}
		
		public Yorus( Serial serial ) : base( serial )
		{
		}
