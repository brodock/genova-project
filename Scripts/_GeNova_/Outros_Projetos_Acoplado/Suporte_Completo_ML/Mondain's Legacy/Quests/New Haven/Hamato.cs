...
namespace Server.Engines.Quests
{
	...
	{   				
		...
		public override object Title{ get{ return 1078007; } }
	...
	public class Hamato : MondainQuester
	{
		...
		[Constructable]
		public Hamato() : base( "Hamato", "The Bushido Instructor" )
		{   
			...
			SetSkill( SkillName.Bushido, 65.0, 90.0 );
		}
		
		public Hamato( Serial serial ) : base( serial )
		{
		}  
