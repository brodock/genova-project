...
{				
	...
	{							
		/* Misplaced */
		public override object Title{ get{ return 1074438; } }
		...
		public override object Description{ get{ return 1074439; } }
		
		/* *tense sigh* Of course, I understand.  If you change your mind, I'll be waiting. */
		public override object Refuse{ get{ return 1074441; } }
		...
		public override object Uncomplete{ get{ return 1074442; } }
		...
		public override object Complete{ get{ return 1074443; } }
	
		public MisplacedQuest() : base()
		{			
	...
	public class Cohenn : MondainQuester
	{
		...
		[Constructable]
		public Cohenn() : base( "Master Cohenn", "the librarian" )
		{			
		}
		
		public Cohenn( Serial serial ) : base( serial )
		{
		}
