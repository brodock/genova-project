...
namespace Server.Engines.Quests
{
	...
	{				
		/* Dreadhorn */
		public override object Title{ get{ return 1074645; } }
		...
		public override object Description{ get{ return 1074646; } }
		
		/* How can you not feel as I do? */
		public override object Refuse{ get{ return 1074647; } }
		...
		public override object Uncomplete{ get{ return 1074648; } }
		
		/* Thank you.  I haven't the words to express my gratitude. */
		public override object Complete{ get{ return 1074649; } }
	
		public DreadhornQuest() : base()
		{			
	...
	public class Calendor : MondainQuester
	{
		...
		[Constructable]
		public Calendor() : base( "Lorekeeper Calendor", "the keeper of tradition" )
		{			
			SetSkill( SkillName.Meditation, 60.0, 83.0 );
			SetSkill( SkillName.Focus, 60.0, 83.0 );
		}
		
		public Calendor( Serial serial ) : base( serial )
		{
		}		
