...
namespace Server.Engines.Quests
{
	...
	{				
		...
		public OverpopulationQuest() : base()
		{			
	...
	{				
		...
		public NewLeadershipQuest() : base()
		{			
			AddObjective( new SlayObjective( typeof( SerpentsFangHighExecutioner ), "serpent's fang high executioner", 1, "Citadel" ) );
			AddObjective( new SlayObjective( typeof( TigersClawThief ), "tiger's claw thief", 1, "Citadel" ) );
			AddObjective( new SlayObjective( typeof( DragonsFlameGrandMage ), "dragon's flame mage", 1, "Citadel" ) );
		...
		{
			return MondainsLegacy.TheCitadel;
		}
	...
	{				
		...
		{
			public InternalObjective() : base( typeof( SerpentsFangAssassin ), "male serpent's fang assassins", 10, "Citadel" )
			{
			}
	...
	{				
		...
		public ExtinguishingTheFlameQuest() : base()
		{			
			AddObjective( new InternalObjective() );
		...
		private class InternalObjective : SlayObjective
		{
			public InternalObjective() : base( typeof( DragonsFlameMage ), "male dragon's flame mages", 10, "Citadel" )
			{
			}
	...
	{				
		...
		public DeathToTheNinjaQuest() : base()
		{			
	...
	{				
		...
		public CrimeAndPunishmentQuest() : base()
		{			
			AddObjective( new InternalObjective() );
		...
		private class InternalObjective : SlayObjective
		{
			public InternalObjective() : base( typeof( TigersClawThief ), "male tiger's claw thieves", 10, "Citadel" )
			{
			}
	...
	{		
		...
		[Constructable]
		public Acob() : base( "Elder Acob", "the wise" )
		{			
