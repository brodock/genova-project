...
{	
	...
	{					
		public override TimeSpan RestartDelay{ get{ return TimeSpan.FromHours( 1 ); } } // not there on OSI, but prevents farming
		
		/* Embracing Humanity */
		public override object Title{ get{ return 1074349; } }
		...
		public override object Description{ get{ return 1074357; } }
		
		/* That's okay, I'll find someone else to make the delivery. */
		public override object Refuse{ get{ return 1074459; } }
		
		/* If I knew where my cousin was, I'd make the delivery myself. */
		public override object Uncomplete{ get{ return 1074460; } }
		
		/* Oh, hello there.  What do you have for me? */
		public override object Complete{ get{ return 1074461; } }
		
		public EmbracingHumanityQuest() : base()
		{					
	...
	public class Ioseph : MondainQuester
	{
		...
		public Ioseph( Serial serial ) : base( serial )
		{
		}
