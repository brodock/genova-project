...
namespace Server.Items
{
	public class MoonglowDonationBox : BaseCollectionItem
	{
		...
		[Constructable]
		public MoonglowDonationBox() : base( 0x9AA )
		{
			Hue = 0x48D;
			StartTier = 1000000;
			NextTier = 500000;
		...
		public MoonglowDonationBox( Serial serial ) : base( serial )
		{			
		}
		...
		public override void Init()
		{
			...
			Rewards.Add( new CollectionItem( typeof( RoyalZooPlateFemaleChest ), 0x1411, 1073224, 0x109, 550000.0 ) );
