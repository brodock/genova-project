...
namespace Server.Items
{
	...
	{
		public override Collection CollectionID{ get{ return Collection.UnderstandingAnimals; } }
		public override int MaxTier{ get{ return 1; } }
		
		[Constructable]
		public UnderstandingAnimals() : base( "Margo", "the animal trainer" )
		{
			StartTier = 10000000;
			DailyDecay = 100000;
		...
		public UnderstandingAnimals( Serial serial ) : base( serial )
		{			
		}
		...
		public override void Init()
		{
			...
			Donations.Add( new CollectionItem( typeof( RedScales ), 0x26B4, 1060883, 0x66D, 20 ) );	
			Donations.Add( new CollectionItem( typeof( YellowScales ), 0x26B4, 1060883, 0x8A8, 20 ) );				
