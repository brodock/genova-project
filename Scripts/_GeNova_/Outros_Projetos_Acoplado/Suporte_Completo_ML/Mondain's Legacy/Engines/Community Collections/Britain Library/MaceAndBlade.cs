...
namespace Server.Items
{
	...
	{
		public override Collection CollectionID{ get{ return Collection.MaceAndBlade; } }
		public override int MaxTier{ get{ return 1; } }
		
		[Constructable]
		public MaceAndBlade() : base( "Talbart", "the warrior" )
		{
			StartTier = 10000000;
			DailyDecay = 100000;
		...
		public MaceAndBlade( Serial serial ) : base( serial )
		{			
		}
		...
		public override void Init()
		{
			...
			Rewards.Add( new CollectionItem( typeof( MaceAndShieldGlasses ), 0x2FB8, 1073360, 0x1DD, 800000.0 ) );				
		}
