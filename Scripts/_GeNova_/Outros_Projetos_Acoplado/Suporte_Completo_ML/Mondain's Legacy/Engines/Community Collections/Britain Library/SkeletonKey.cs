...
namespace Server.Items
{
	...
	{
		public override Collection CollectionID{ get{ return Collection.SkeletonKey; } }
		public override int MaxTier{ get{ return 1; } }
		
		[Constructable]
		public SkeletonKey() : base( "Enrico", "the thief" )
		{
			StartTier = 10000000;
			DailyDecay = 100000;
		...
		public SkeletonKey( Serial serial ) : base( serial )
		{			
		}
