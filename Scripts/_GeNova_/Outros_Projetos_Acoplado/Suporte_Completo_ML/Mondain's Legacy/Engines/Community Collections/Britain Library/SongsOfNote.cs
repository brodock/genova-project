...
namespace Server.Items
{
	...
	{
		public override Collection CollectionID{ get{ return Collection.SongsOfNote; } }
		public override int MaxTier{ get{ return 1; } }
		
		[Constructable]
		public SongsOfNote() : base( "Xanthe", "the musician" )
		{
			StartTier = 10000000;
			DailyDecay = 100000;
			
			DonationLabel = 1073450; // Songs of Note Section Donation Representative.
		}
		
		public SongsOfNote( Serial serial ) : base( serial )
		{			
		}
		...
		public override void Init()
		{
			...
			Donations.Add( new CollectionItem( typeof( Drums ), 0xE9C, 1015116, 0x0, 8 ) );		
			Donations.Add( new CollectionItem( typeof( Lute ), 0xEB3, 1015117, 0x0, 8 ) );				
			...
			Rewards.Add( new CollectionItem( typeof( LyricalGlasses ), 0x2FB8, 1073382, 0x47F, 800000.0 ) );				
		}
