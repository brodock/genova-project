...
{	
	...
	{	
		...
		[Constructable]
		public SherryTheMouseQuotes() : base( 0xFBD )
		{
			LootType = LootType.Blessed;
			Weight = 5.0;			
		}

		public SherryTheMouseQuotes( Serial serial ) : base( serial )
		{
		}
	...
	{	
		public override int LabelNumber{ get{ return 1073310; } } // Library Friends - Quotes from the pen of Wyrd Beastmaster
		
		[Constructable]
		public WyrdBeastmasterQuotes() : base( 0xFBD )
		{
			LootType = LootType.Blessed;
			Weight = 5.0;			
		}

		public WyrdBeastmasterQuotes( Serial serial ) : base( serial )
		{
		}
	...
	{	
		...
		[Constructable]
		public MercenaryJustinQuotes() : base( 0xFBD )
		{
			LootType = LootType.Blessed;
			Weight = 5.0;			
		}

		public MercenaryJustinQuotes( Serial serial ) : base( serial )
		{
		}
	...
	{	
		...
		[Constructable]
		public HeigelOfMoonglowQuotes() : base( 0xFBD )
		{
			LootType = LootType.Blessed;
			Weight = 5.0;			
		}

		public HeigelOfMoonglowQuotes( Serial serial ) : base( serial )
		{
		}
	...
	{	
		...
		[Constructable]
		public TraderHoraceQuotes() : base( 0xFBD )
		{
			LootType = LootType.Blessed;
			Weight = 5.0;			
		}

		public TraderHoraceQuotes( Serial serial ) : base( serial )
		{
		}
