...
namespace Server.Items
{
	...
	{
		public override MagicalFood FoodID{ get{ return MagicalFood.EnchantedApple; } }
		public override TimeSpan Cooldown{ get{ return TimeSpan.FromMinutes( 2 ); } }
		public override int EatMessage{ get{ return 1074846; } } // A tasty bite of the enchanted apple lifts all curses from your soul.
		
		[Constructable]
		public EnchantedApple() : base( 0x2FD8 )
		{
			Weight = 1.0;
			Hue = 0x488;
		}
	
		public EnchantedApple( Serial serial ) : base( serial )
		{
		}
