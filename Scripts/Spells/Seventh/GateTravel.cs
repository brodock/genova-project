...
namespace Server.Spells.Seventh
{
	public class GateTravelSpell : MagerySpell
	{
		...
		public void Effect( Point3D loc, Map map, bool checkMulti )
		{
            ...
            // Genova: restricao para magia em mundos restritos.
            else if (PersonagemEmMundoRestrito.Confirmar(Caster))
            {
                Caster.SendMessage(PersonagemEmMundoRestrito.Mensagem);
            }
