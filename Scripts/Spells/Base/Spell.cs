...
namespace Server.Spells
{
    public abstract class Spell : ISpell
    {
        ...
        private Mobile m_MobileTargeted;
        #endregion
        ...
        #region GeNova: KR Supports
        internal Mobile Targeted { get { return m_MobileTargeted; } }
        #endregion
        ...
        #region GeNova: KR Supports
        /// <summary>
        /// Indirect method to set the target to be reached. Use specific to KR Tools bar.
        /// </summary>
        public void DefineTargetForeignSpell(Mobile mobile)
        {
            this.m_MobileTargeted = mobile;
        }
        #endregion
