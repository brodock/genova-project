...
namespace Server.Misc
{
	public class CharacterCreation
	{
		...
		private static void SetName( Mobile m, string name )
		{
            ...
            // Genova: setando por atributo global o minimo e maximo para tamanho do nome.
            if (!NameVerification.Validate(name, RegistroDePersonagem.NomeTamanhoMinimo, RegistroDePersonagem.NomeTamanhoMaximo, true, false, true, 1, NameVerification.SpaceDashPeriodQuote))
				name = "Generic Player";
